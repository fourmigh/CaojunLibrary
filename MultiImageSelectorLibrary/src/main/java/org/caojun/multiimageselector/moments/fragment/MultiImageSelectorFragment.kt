package org.caojun.multiimageselector.moments.fragment
...
import org.caojun.multiimageselector.BuildConfig
import org.caojun.multiimageselector.R
import org.caojun.multiimageselector.adapter.FolderAdapter
import org.caojun.multiimageselector.adapter.ImageGridAdapter
import org.caojun.multiimageselector.bean.Folder
import org.caojun.multiimageselector.bean.Image
import org.caojun.multiimageselector.moments.utils.FileUtils
import org.caojun.multiimageselector.moments.utils.ScreenUtils
import java.io.File
...
//                                    folder.images = imageList
    ...
    private fun showCamera(): Boolean {
        return arguments == null || arguments?.getBoolean(EXTRA_SHOW_CAMERA, true)?:false
    }

    private fun selectMode(): Int {
        return if (arguments == null) MODE_MULTI else arguments?.getInt(EXTRA_SELECT_MODE)?:MODE_SINGLE
    }

    private fun selectImageCount(): Int {
        return if (arguments == null) 9 else arguments?.getInt(EXTRA_SELECT_COUNT)?:1
    }
